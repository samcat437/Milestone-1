...
3. The Contact form will have the following input elements :  
    ...
    * Venue Postcode - inpute with the required attribute.
...
4. There will have a submit button at the bottom of the page.
    * The button will change colour when hovered.
...
6. Upon submitting the form correctly, the user will be given feedback that their form has been received and an update on current response times.
...
* A videos page to showcase the broad range of repertoire offered by the group- **Second release**
...
Contact Us Page Wireframe - [View](https://github.com/samcat437/Milestone-1/blob/main/assets/wireframes/Enquiry%20Form%20Wireframe.png)
Contact Us Page Mobile Wireframe - [View](https://github.com/samcat437/Milestone-1/blob/main/docs/wireframes/contact-form-wireframe-mobile.png)
